 ...
 *  of a JScrollPane.
 */
public class TextLineNumber extends RSyntaxTextArea
	implements CaretListener, DocumentListener, PropertyChangeListener
{
	 ...
	 */
	public TextLineNumber(RSyntaxTextArea textArea)
	{
		this(textArea, 3);
	}
	 ...
	 */
	public TextLineNumber(RSyntaxTextArea textArea, int minimumDisplayDigits)
	{
		...
		SwingUtilities.invokeLater(new Runnable()
		{
			...
			public void run()
			{
				try
				{
					...
					Rectangle rect = textArea.modelToView(endPos);
